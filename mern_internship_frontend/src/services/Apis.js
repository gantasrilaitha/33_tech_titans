...
export const usergetfunc = async(search,searchdomain,status,sort,page)=>{
    return await commonrequest("GET",`${BASE_URL}/user/details?search=${search}&searchdomain=${searchdomain}&status=${status}&sort=${sort}&page=${page}`,"");
}
