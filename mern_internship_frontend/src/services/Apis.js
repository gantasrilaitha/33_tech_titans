...
export const usergetfunc = async(search,domain,status,sort,page)=>{
    return await commonrequest("GET",`${BASE_URL}/user/details?search=${search}&domain=${domain}&status=${status}&sort=${sort}&page=${page}`,"");
}
